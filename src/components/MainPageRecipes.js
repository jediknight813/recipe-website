...
const MainPageRecipes = () =>{ 
    ...
    return (
        <div className="w-full h-auto flex flex-col items-center gap-8 tb:w-[690px] tb:flex-row tb:flex-wrap tb:justify-between mdt:w-[85%] mdt:flex-nowrap dt:w-[80%]">
            ...
            <div className="h-auto w-full flex flex-col items-center gap-4 mdt:order-2 mdt:max-w-[34%] cursor-pointer shadow-lg">
            ...
            <div className=" h-auto w-[95%] flex flex-col gap-2 tb:w-[46%] mdt:order-1 mdt:w-[300px]">
                ...
                <div className=" max-w-full h-auto flex flex-row-reverse tb:flex-col cursor-pointer shadow-lg pb-2">
            ...
            <div className=" w-[95%] h-auto text-center tb:w-[48%] border-solid border-2 border-gray-500 p-5 rounded-md mdt:order-3 mdt:max-w-[320px] shadow-lg">
