    ...
    return (
        <div className=" w-full h-auto flex flex-col bg-slate-300/40 border-t-2 items-center gap-4 mt-20 tb:flex-row tb:flex-wrap tb:justify-around">
            ...
            <div className=" flex flex-col items-center gap-4 tb:w-[48%] dt:w-[30%]">
                ...
                <h1 className=" font-extralight">Follow Us</h1>
                <div className=" flex">
                ...
                <h3 className=" font-extralight text-sm underline">Subscribe to Our Newsletter</h3>
            </div>

            <div className="pb-16 border-b-gray-500/50 border-solid dt:hidden"></div>

            <div className="hidden dt:inline dt:w-full dt:pb-16"> </div>
        </div>
    )
}
